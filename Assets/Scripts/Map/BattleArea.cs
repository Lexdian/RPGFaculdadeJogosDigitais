...
public struct EnemyGroup
{
    ...
    private bool ValidarColuna(EnemySO[] coluna, string nome, out string error)
    {
        ...
        {
            error = $"Coluna {nome} mista! N�o pode ter grandes e pequenos juntos.";
            return false;
        }
...
public class BattleArea : MonoBehaviour
{
    ...
    private float nextEncounterThreshold = 2f; // Tempo m�nimo entre tentativas
